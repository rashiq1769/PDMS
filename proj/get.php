...
<input class="w3-input w3-border" type="number" placeholder=" MM " name="fmm" min="1" max="12" required>
</div>
<div class="w3-quarter w3-margin-bottom">
<br>
<input class="w3-input w3-border" type="number" placeholder=" YYYY " name="fyy" required>
</div>
<div class="w3-quarter">
<label><i class="fa fa-calendar-o"></i> To </label>
<input class="w3-input w3-border" type="number" placeholder=" MM " name="tmm" min="1" max="12" required>
</div>
<div class="w3-quarter">
<br>
<input class="w3-input w3-border" type="number" placeholder=" YYYY " name="tyy" required><br><br>
</div>
</div>
...
<button class="w3-button w3-dark-grey" name="submit" type="submit"><i class="fa fa-search w3-margin-right"></i>  Get Data  </button>
<?php
